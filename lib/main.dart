...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
     ...
     * and subtke switching animation.
     */
    ...
    return Scaffold(
      body: LayoutBuilder(builder: (context, constraints) {
        if (constraints.maxWidth < 450) {
          /**
           * Use a more mobile-friendly layout with BottomNavigation
           * on narrow screens
           */
          return Column(
            children: [
...
class _HistoryListViewState extends State<HistoryListView> {
  /// Needed so that [MyAppState] can tell [AnimatedList] below
  /// to animate new items;
